...
public class FluentValidator<TValidator> : ComponentBase where TValidator : IValidator, new()
{
    ...
    protected override void OnInitialized()
    {
        ...
        EditContext.OnFieldChanged += (sender, eventArgs)
           => ValidateModel((EditContext)sender, messages, eventArgs.FieldIdentifier);
    ...
    private void ValidateModel(EditContext editContext, ValidationMessageStore messages, FieldIdentifier? field = default)
    {
        if (field == null) IsValidated = true;
        ...
        foreach (var error in validationResult.Errors)
        {
            ...
            if (field != null && !IsValidated)
            {

                if (fieldIdentifier.FieldName == field.Value.FieldName)
