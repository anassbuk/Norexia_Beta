            ...
            modelBuilder.Entity("Norexia.Core.Domain.SaleOrderEntities.PaymentMean", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("54c62697-9fbe-48f4-8cc8-80fcab8caeda"),
                        ...
                        new
                        {
                            Id = new Guid("79b0ae9d-3aa0-4a8c-9884-d8fc4c6ac4ae"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            Name = "Virement"
                        },
                        new
                        {
                            Id = new Guid("9f6a4fba-4ae1-4ae6-bb6a-61cf84736095"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            Name = "Chèque"
                        });
            ...
            modelBuilder.Entity("Norexia.Core.Domain.SaleOrderEntities.PaymentTerms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b69996f2-aaa6-4913-9f74-67bdd5491872"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DepositInvoice = true,
            ...
            modelBuilder.Entity("Norexia.Core.Domain.SettingEntities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5f4199e0-20a2-46f3-a64b-6d028dc5d798"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDefault = true,
                            IsDeleted = false,
                            Name = "MAD"
            ...
            modelBuilder.Entity("Norexia.Core.Domain.SettingEntities.VAT", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("14148d5e-830d-418e-b1c8-00c357686a50"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDefault = true,
                            IsDeleted = false,
                            Value = 0.02m
