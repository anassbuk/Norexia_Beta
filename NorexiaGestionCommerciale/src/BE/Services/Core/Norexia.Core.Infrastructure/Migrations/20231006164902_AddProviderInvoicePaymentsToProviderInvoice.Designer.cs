...
namespace Norexia.Core.Infrastructure.Migrations
{
    ...
    [Migration("20231006164902_AddProviderInvoicePaymentsToProviderInvoice")]
    partial class AddProviderInvoicePaymentsToProviderInvoice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Norexia.Core.Domain.PaymentEntities.ProviderInvoicePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProviderInvoicePayments", "app");
                });
            ...
            modelBuilder.Entity("Norexia.Core.Domain.ProviderInvoiceEntities.AttachedDigitalInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AttachedDigitalInvoice", "app");
                });
            ...
            modelBuilder.Entity("Norexia.Core.Domain.SaleOrderEntities.PaymentMean", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8e480f5a-e01a-49bf-a173-b98e1d79660d"),
                        ...
                        new
                        {
                            Id = new Guid("c14558f1-e20a-42e1-9fee-68fadee9b1ac"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            Name = "Virement"
                        },
                        new
                        {
                            Id = new Guid("6a3e5148-dad3-4a27-afcf-65a4dc7001dc"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            Name = "Chèque"
                        });
            ...
            modelBuilder.Entity("Norexia.Core.Domain.SaleOrderEntities.PaymentTerms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6a776e74-305c-4fcc-a8f1-8d618a6bb014"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DepositInvoice = true,
            ...
            modelBuilder.Entity("Norexia.Core.Domain.SettingEntities.Currency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f3a7f024-7a5c-4b88-b40f-de26a1523eae"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDefault = true,
                            IsDeleted = false,
                            Name = "MAD"
            ...
            modelBuilder.Entity("Norexia.Core.Domain.SettingEntities.VAT", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("be9194d2-4742-4ef6-a357-226f10920878"),
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDefault = true,
                            IsDeleted = false,
                            Value = 0.02m
            ...
            modelBuilder.Entity("Norexia.Core.Domain.PaymentEntities.ProviderInvoicePayment", b =>
                {
                    ...
                    b.HasOne("Norexia.Core.Domain.ProviderInvoiceEntities.ProviderInvoice", "ProviderInvoice")
                        .WithMany("ProviderInvoicePayments")
            ...
            modelBuilder.Entity("Norexia.Core.Domain.ProviderInvoiceEntities.AttachedDigitalInvoice", b =>
                {
                    b.HasOne("Norexia.Core.Domain.ProviderInvoiceEntities.ProviderInvoice", null)
                        .WithMany("AttachedDigitalInvoices")
                        .HasForeignKey("ProviderInvoiceId");
                });
            ...
            modelBuilder.Entity("Norexia.Core.Domain.ProviderInvoiceEntities.ProviderInvoice", b =>
                {
                    b.Navigation("AttachedDigitalInvoices");

                    b.Navigation("ProviderInvoiceLines");

                    b.Navigation("ProviderInvoicePayments");
                });
